...
const ViewStudent = () => {
    ...
    const fields = password === ""
        ? { name, lastName, rollNum }
        : { name, lastName, rollNum, password }
    ...
    useEffect(() => {
        if (userDetails) {
            ...
            setAdminID(userDetails.adminID || '');
            setRole(userDetails.role || '');
            setAadharCard(userDetails.aadharCard || '');
            setResidentialAddress(userDetails.ResidentialAddress || '');
